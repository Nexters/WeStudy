...
public class Facebook {
    ...
    /**
     * custom authorize method. (WeStudy Facebook Login)
     * @param activity
     * @param permissions
     * @param listener
     */
    public void authorize2(Activity activity, String[] permissions, final DialogListener listener){
        authorize2(activity, permissions, DEFAULT_AUTH_ACTIVITY_CODE, listener);
    }

    /**
     * custom authorize method.
     * @param activity
     * @param permissions
     * @param defaultAuthActivityCode
     * @param listener
     */
    private void authorize2(Activity activity, String[] permissions, int defaultAuthActivityCode, final DialogListener listener) {
